import openai
import os
from parser_helper import parse_nmap_xml  # Importing the parse helper function.
...
def query_openai(prompt):
    try:
        ...
        exit()
        # Consider Additional error handling as needed
    except Exception as e:
        print(f"An unexpected error occurred: {e}")
        exit()

# Get the parsed Nmap data
nmap_data = parse_nmap_xml('output.xml')  # using hardcoded file path for now to test.
...
## add try/except for handling interruptions-